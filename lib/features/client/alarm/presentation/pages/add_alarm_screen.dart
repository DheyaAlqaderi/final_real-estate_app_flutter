...
import 'package:smart_real_estate/features/client/alarm/presentation/manager/address/city/city_cubit.dart';
...
import 'package:smart_real_estate/features/client/alarm/presentation/manager/attribute/attribute_alarm_cubit_state.dart';
...
import 'package:smart_real_estate/features/client/alarm/presentation/widget/button_drop_down.dart';
...
List<Attrib> parseJsonData() {
  ...
  // Parse JSON data into Attrib objects
  List<Attrib> attribList = jsonData.map((json) => Attrib.fromJson(json)).toList();
  return attribList;
}

// Example JSON data
const Map<String, dynamic> categoryJson = {
  "count": 3,
  "next": null,
  "previous": null,
  "results": [
